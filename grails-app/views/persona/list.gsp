			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="esEmpleado" title="${message(code: 'persona.esEmpleado.label', default: 'Es Empleado')}" />
				...
				<g:each in="${personaInstanceList}" status="i" var="personaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatBoolean boolean="${personaInstance.esEmpleado}" /></td>
