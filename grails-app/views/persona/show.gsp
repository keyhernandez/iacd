	...
	<body>
		...
		<div id="show-persona" class="content scaffold-show" role="main">
			...
			<ol class="property-list persona">
				...
				<g:if test="${personaInstance?.esEmpleado}">
				<li class="fieldcontain">
					<span id="esEmpleado-label" class="property-label"><g:message code="persona.esEmpleado.label" default="Es Empleado" /></span>
					
						<span class="property-value" aria-labelledby="esEmpleado-label"><g:formatBoolean boolean="${personaInstance?.esEmpleado}" /></span>
