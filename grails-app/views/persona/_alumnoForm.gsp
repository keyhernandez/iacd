...
<div class="fieldcontain ${hasErrors(bean: personaInstance, field: 'tipoPersona', 'error')} form-group">
  <g:hiddenField name="tipoPersona" value="Alumno"/>
</div>

<div class="fieldcontain ${hasErrors(bean: personaInstance, field: 'fechaNac', 'error')} required form-group">
  <label for="fechaNac" class="col-lg-4 control-label">
    <g:message code="persona.fechaNac.label" default="Fecha de Nacimiento" />
    <span class="required-indicator">*</span>
  </label>
  <div class="col-lg-4">
    <g:datePicker name="fechaNac" precision="day" relativeYears="[-4..-100]" value="${personaInstance?.fechaNac}" class="form-control" />
  </div>
</div>
...
<%-- ajax link to remove entries --%>
      <label class="col-lg-4 control-label"><g:message code="telefono.label" default="Telefono" /></label>

      <input type="button" class="actionButton" 
             onclick="myScripts.ajaxPostReplace('${formId}', '${elementToReplace}', '${createLink(action: 'alumnoRemoveTelefono', params:[removeIx: i])}')" 
  ...
  <br>
  <label for="telefonos" class="col-lg-4 control-label">
    <g:message code="persona.telefonos.label" default="Agregar Telefono" />

  </label>

<%-- ajax link to add new entries --%>
  <input type="button" rel="nofollow" class="actionButton" href="javascript:void(0)" 
         onclick="myScripts.ajaxPostReplace('${formId}', '${elementToReplace}', '${createLink(action: 'alumnoAddTelefono')}')" 
