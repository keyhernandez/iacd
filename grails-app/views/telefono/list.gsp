			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="codigo" title="${message(code: 'telefono.codigo.label', default: 'Codigo')}" />
				...
				<g:each in="${telefonoInstanceList}" status="i" var="telefonoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${telefonoInstance.id}">${fieldValue(bean: telefonoInstance, field: "codigo")}</g:link></td>
