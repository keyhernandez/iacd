    ...
    <body>
        ...
        <div id="show-factura" class="content scaffold-show" role="main">
            ...
            <ol class="property-list factura">
                ...
                <g:if test="${facturaInstance?.tipoPago}">
                    <li class="fieldcontain">
                        <span id="tipoPago-label" class="property-label"><g:message code="factura.tipoPago.label" default="Tipo Pago" /></span>

                        <span class="property-value" aria-labelledby="tipoPago-label"><g:fieldValue bean="${facturaInstance}" field="tipoPago"/></span>
